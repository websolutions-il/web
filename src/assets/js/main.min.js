function playHeaderVideo(){document.getElementById("myVideo").play()}function flexSlider(){$(".flexslider").flexslider({animation:"slide",animationLoop:!0,controlNav:!1})}function setScrollBarForAppointmentsStep2(){$("#scrolling_list, #scrolling_list2, #scrolling_list3").mCustomScrollbar({autoHideScrollbar:!0,theme:"rounded"})}function setScrollBar(){$("#content-1").mCustomScrollbar({autoHideScrollbar:!0,theme:"rounded"})}function allowOnlyNumbers(){$("input[type=tel]").on("keypress keyup blur",function(n){$(this).val($(this).val().replace(/[^\d].+/,""));(n.which<48||n.which>57)&&n.preventDefault()})}function arrowDownPreviosCall106(){jQuery(".refrence_table tbody").each(function(){var n=jQuery(this);jQuery("a.imgText",n).click(function(t){t.preventDefault();var i=!1;return $(this).hasClass("arrowDown")&&(i=!0),$("a.imgText").removeClass("arrowDown"),i||$(this).addClass("arrowDown"),$div=jQuery("tr.showtd",n),$div.fadeToggle("1000","linear"),jQuery("tr.showtd").not($div).hide("1000"),!1})});jQuery("html").click(function(){jQuery("div.showtd").hide("1000")})}function appointmentsUserDetails(){$(".selectholder").each(function(){$(this).children().hide();var n=$(this).children("label").text();$(this).append('<span class="desc">'+n+"<\/span>");$(this).append('<span class="pulldown"><\/span>');$(this).append('<div class="selectdropdown" style="display:none;"><\/div>');$(this).children("select").children("option").each(function(){if($(this).attr("value")!="0"){$drop=$(this).parent().siblings(".selectdropdown");var n=$(this).attr("value");$drop.append("<span>"+n+"<\/span>")}});$(this).click(function(){$(this).hasClass("activeselectholder")?($(this).children(".selectdropdown").slideUp(200),$(this).removeClass("activeselectholder"),$(this).children("select").val()!="0"&&$(this).children(".desc").fadeOut(100,function(){$(this).text($(this).siblings("select").val());$(this).fadeIn(100)})):($(".activeselectholder").each(function(){$(this).children(".selectdropdown").slideUp(200);$(this).children("select").val()!="0"&&$(this).children(".desc").fadeOut(100,function(){$(this).text($(this).siblings("select").val());$(this).fadeIn(100)});$(this).removeClass("activeselectholder")}),$(this).children(".selectdropdown").slideDown(200),$(this).addClass("activeselectholder"),$(this).children("select").val()!="0"&&$(this).children(".desc").fadeOut(100,function(){$(this).text($(this).siblings("select").children("option[value=0]").text());$(this).fadeIn(100)}))})});$(".selectholder .selectdropdown span").click(function(n){selectedPrefix=n.target.innerHTML;$(this).siblings().removeClass("active");$(this).addClass("active");var t=$(this).text();$(this).parent().siblings("select").val(t);$(this).parent().siblings(".desc").fadeOut(100,function(){$(this).text(t);$(this).fadeIn(100)})})}function resetCaptcha(){grecaptcha.reset(recaptcha2)}function arrowMyOpend(){jQuery(".refrence_table tbody").each(function(){var n=jQuery(this);jQuery("a.imgText",n).click(function(t){t.preventDefault();var i=!1;return $(this).hasClass("arrowDown")&&(i=!0),$("a.imgText").removeClass("arrowDown"),i||$(this).addClass("arrowDown"),$div=jQuery("tr.showtd",n),$div.fadeToggle("1000","linear"),jQuery("tr.showtd").not($div).hide("1000"),!1})});jQuery("html").click(function(){jQuery("div.showtd").hide("1000")})}var selectedPrefix="",onloadCallback=function(){recaptcha2=grecaptcha.render("recaptcha2",{sitekey:"6LdNthAUAAAAAItribt1-VmPoOC_H5ZYrDxXaf3c",theme:"light"})};
/*!
